...
- (id)init
{
    if (self = [super init])
    {
        ...
        [self addButtonWithTitle:NSLocalizedStringFromTable(@"取消", @"SinaLocalizable", nil)];
		[self addButtonWithTitle:NSLocalizedStringFromTable(@"登录", @"SinaLocalizable", nil)];
        ...
        [userIDLabel setText:NSLocalizedStringFromTable(@"用户名", @"SinaLocalizable", nil)];
        ...
        [passwordLabel setText:NSLocalizedStringFromTable(@"密码", @"SinaLocalizable", nil)];
